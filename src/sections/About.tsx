        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div ref={contentRef} className="order-1 lg:order-2">
            ...
            <div className="space-y-4 text-white/70 text-lg leading-relaxed mb-8">
              ...
              <p>
                My approach combines clean code with pixel-perfect design,
                ensuring that every project I work on not only functions
                flawlessly but also delivers an exceptional user experience. I'm
